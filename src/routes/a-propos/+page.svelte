...
<section class="mx-auto max-w-reader px-6 py-10 font-body">
	...
	<p class="mt-4">
		Tradition Apostolique est une anthologie patristique française, organisée par sujets. Le corpus
		est progressivement enrichi à partir de sources primaires (Patrologie Latine, Patrologie
		Grecque, Corpus Christianorum) et de traductions originales.
	</p>
	<p class="mt-3">
